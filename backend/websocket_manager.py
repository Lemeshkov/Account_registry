...
# from datetime import datetime, date
# from decimal import Decimal  # Правильный импорт Decimal
# from fastapi import WebSocket
# import asyncio
...
#         """Отправка сообщения всем подписчикам batch"""
#         if batch_id in self.batch_subscriptions:
#             logger.info(f"Broadcasting to batch {batch_id}: {message.get('type', 'unknown')}")
...
#     def __init__(self):
#         # ... существующий код ...
#         self.user_connections = {}  # user_id -> [client_ids]
#         self.client_to_user = {}  # client_id -> user_id
