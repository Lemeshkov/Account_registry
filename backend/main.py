...
# ):
#     """
#     Отправить дефектную ведомость на согласование
#     """
...
#     # Находим всех согласователей
#     approvers = db.query(User).filter(User.role.in_(["approver", "admin"])).all()
    
#     # Создаем уведомления для всех согласователей
...
#     # Отправляем WebSocket уведомления всем согласователям
#     for approver in approvers:
...
# ):
#     """
#     Согласовать или отклонить дефектную ведомость
#     """
#     # Проверяем права
...
#     # Отправляем WebSocket уведомление создателю
#     if sheet.created_by:
...
# ):
#     """
#     Получить список ведомостей, ожидающих согласования
#     """
#     if current_user.role not in ["approver", "admin"]:
...
# ):
#     """
#     Получить ведомости, созданные текущим пользователем
#     """
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000"],  # Только один точный origin
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["*"],
